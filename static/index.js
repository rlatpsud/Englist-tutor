    ...
    function gettoken(){
        ...
        request.open('POST', '/test/gettoken', true);
    ...
    hbutton.onclick = function () {
        ...
        if(reftextval != lastgettstext){
            ...
            var request = new XMLHttpRequest();
            request.open('POST', '/test/gettts', true);
    ...
    function getttsforword(word){
        var request = new XMLHttpRequest();
        request.open('POST', '/test/getttsforword', true);
        request.responseType = "blob";
    ...
    ttbutton.onclick = function () {
        var request = new XMLHttpRequest();
        request.open('POST', '/test/gettonguetwister', true);
    ...
    function createDownloadLink(blob) {
        ...
        var request = new XMLHttpRequest();
        request.open('POST', '/test/ackaud', true);
